...
class GoodVibes extends StatefulWidget {
  @override
  _GoodVibesState createState() => _GoodVibesState();
}

class _GoodVibesState extends State<GoodVibes> {
  bool toggle1 = false;
  bool toggle2 = false;
  bool status = false;
              ...
              child: Padding(
                ...
                child: Center(
                  child: Column(
                    children: <Widget>[
                      Image(
                        image: AssetImage('lib/assets/images/goodVibes.png'),
